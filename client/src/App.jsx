...
import PersonalInfoPortal from "./pages/PersonalInfoPortal/PersonalInfoPortal";
...
import FacultyRequests from "./pages/FacultyRequests/FacultyRequests.jsx";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path={`${base}/profile/:id?/:reqID?`}
          element={<PersonalInfoPortal />}
        />
        ...
        <Route path={`${base}/logsPage`} element={<LogsPage />} />
        <Route
          path={`${base}/faculty/requestes`}
...
const UnderDevelopment = () => {
  return (
    <div className="h-screen flex items-center justify-center m-5 text-center">
      <h1 className="alert alert-primary text-3xl font-bold">
        Under Development
      </h1>
    </div>
  );
...
const NotFound = () => {
  return (
    <div className="h-screen vh-100 flex items-center justify-center m-5 text-center">
      <h1 className="alert alert-danger text-3xl font-bold">
...
const NotAuthourized = () => {
  return (
    <div className="vh-100 h-screen flex items-center justify-center m-5 text-center">
      <h1 className="alert alert-warning text-3xl font-bold">
        Not Authourized <strong>401</strong>
      </h1>
    </div>
  );
};
export const NotLoaded = ({ reload }) => {
  return (
    <div className="vh-100 h-screen flex items-center justify-center m-5 text-center">
      ...
      <h2 className="alert alert-warning text-3xl font-bold">
        حدث خطأ اثناء تحميل البيانات
      </h2>
