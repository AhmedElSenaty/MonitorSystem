...
const RegisterForm = () => {
  ...
  const validate = (fields) => {
    ...
    if (fields.includes("employeeType") && !form.employeeType.trim())
      newErrors.employeeType = "نوع الموظف مطلوب";
            ...
            <div className="bs-stepper-header" role="tablist">
              <div className="step" data-target="#personal-part">
                <button type="button" className="step-trigger" role="tab">
                  ...
                  <span className="bs-stepper-label">ادخل بياناتك الشخصية</span>
                </button>
              </div>
